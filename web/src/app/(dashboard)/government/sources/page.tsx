...
export default function GovernmentSourcesPage() {
  ...
  const fetchSources = useCallback(async () => {
    setLoadError(null);
    try {
      const res = await fetch(`${API_BASE}/api/v1/sources?domain=government`);
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <AppPageHeader
        ...
        description="Official procurement, grants, spending and public-data entry points. Connectors come later — catalog is live."
